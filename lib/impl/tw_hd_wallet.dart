...
class TWHDWallet {
  ...
  static TWHDWallet createWithData(Uint8List seed, String passphrase) {
    ...
    final Pointer Function(Pointer<Void>, Pointer<Utf8>) func = walletCoreLib
        .lookup<NativeFunction<Pointer Function(Pointer<Void>, Pointer<Utf8>)>>(
   ...
   Uint8List seed() {
    final Pointer<Void> Function(Pointer) func = walletCoreLib
        .lookup<NativeFunction<Pointer<Void> Function(Pointer)>>(
        'TWHDWalletSeed')
        .asFunction();
