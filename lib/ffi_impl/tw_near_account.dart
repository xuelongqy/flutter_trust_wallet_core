...
class TWNEARAccount extends Opaque {
  ...
  late final _TWNEARAccountCreateWithString_ptr = lookup<NativeFunction<_c_TWNEARAccountCreateWithString>>('TWNEARAccountCreateWithString');
  ...
  late final _TWNEARAccountDelete_ptr = lookup<NativeFunction<_c_TWNEARAccountDelete>>('TWNEARAccountDelete');
