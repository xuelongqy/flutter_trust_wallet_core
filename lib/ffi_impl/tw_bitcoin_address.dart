...
class TWBitcoinAddress extends Opaque {
  ...
  late final _TWBitcoinAddressCreateWithString_ptr = lookup<NativeFunction<_c_TWBitcoinAddressCreateWithString>>('TWBitcoinAddressCreateWithString');
  ...
  late final _TWBitcoinAddressCreateWithData_ptr = lookup<NativeFunction<_c_TWBitcoinAddressCreateWithData>>('TWBitcoinAddressCreateWithData');
  ...
  late final _TWBitcoinAddressCreateWithPublicKey_ptr = lookup<NativeFunction<_c_TWBitcoinAddressCreateWithPublicKey>>('TWBitcoinAddressCreateWithPublicKey');
  ...
  late final _TWBitcoinAddressDelete_ptr = lookup<NativeFunction<_c_TWBitcoinAddressDelete>>('TWBitcoinAddressDelete');
