...
class TWSolanaAddress extends Opaque {
  ...
  late final _TWSolanaAddressCreateWithString_ptr = lookup<NativeFunction<_c_TWSolanaAddressCreateWithString>>('TWSolanaAddressCreateWithString');
  ...
  late final _TWSolanaAddressDelete_ptr = lookup<NativeFunction<_c_TWSolanaAddressDelete>>('TWSolanaAddressDelete');
