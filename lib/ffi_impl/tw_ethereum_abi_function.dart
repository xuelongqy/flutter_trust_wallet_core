...
/// trust wallet core
class TWEthereumAbiFunction_1 {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  TWEthereumAbiFunction_1(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  TWEthereumAbiFunction_1.fromLookup(
  ...
  ffi.Pointer<ffi.Int32> TWEthereumAbiFunctionCreateWithString(
  ...
  late final ffi.Pointer<ffi.Int32> _TW_METHOD_DISCARDABLE_RESULT =
      _lookup<ffi.Int32>('TW_METHOD_DISCARDABLE_RESULT');

  int get TW_METHOD_DISCARDABLE_RESULT => _TW_METHOD_DISCARDABLE_RESULT.value;

  set TW_METHOD_DISCARDABLE_RESULT(int value) =>
      _TW_METHOD_DISCARDABLE_RESULT.value = value;
...
typedef _c_TWEthereumAbiFunctionCreateWithString = ffi.Pointer<ffi.Int32>
    Function(
  ffi.Pointer<ffi.Int32> name,
);

typedef _dart_TWEthereumAbiFunctionCreateWithString = ffi.Pointer<ffi.Int32>
    Function(
  ffi.Pointer<ffi.Int32> name,
);

typedef _c_TWEthereumAbiFunctionDelete = ffi.Int32 Function(
  ffi.Pointer<TWEthereumAbiFunction> fn,
);
